...
These selected examples establish runnable behavior, transparent comparison and repeatability. They do not establish utility-data accuracy, operator adoption, production readiness, outage reduction, formal CIM compliance. Expert assessments are documented separately and apply to their stated scope and reviewed version.
