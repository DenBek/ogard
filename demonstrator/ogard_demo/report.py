...
<p><strong>How to read this:</strong> “accepted by scripted review” means a predeclared synthetic review event was replayed. This report records automated execution and scripted synthetic review. Separately documented expert assessments have their own scope and reviewed version. These selected cases do not establish utility adoption, operational performance or national impact.</p></section>
''' + "".join(cards) + f'''
