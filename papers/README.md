# Public paper editions

Author: Deniz Bektas. Documentation license: CC BY 4.0.

All four papers are public edition v0.1.1, issued on 24 September 2026 in [the public repository](https://github.com/DenBek/ogard). The paper edition is distinct from executable package 0.2.1.

| Paper | Technical source | Public edition |
| --- | --- | --- |
| Technical Whitepaper | Revised manuscript v0.1, 16 September 2026; original draft August 2026 | v0.1.1, 24 September 2026 |
| Implementation Guide | August 2026, Batch 2 v0.1 | v0.1.1, 24 September 2026 |
...
Bektas, D. (2026). *OGARD Technical Whitepaper*. Public edition v0.1.1, 24 September 2026, based on revised manuscript v0.1 of 16 September 2026. https://github.com/DenBek/ogard

Cite companion papers by their individual titles and the same public edition and issue date. The original August draft date does not replace the September revision or public-edition date.
